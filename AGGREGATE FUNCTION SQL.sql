show databases;
#create database bit_da;
create database if not exists bit_da;
use bit_da;
...
select * from bank_details where age = 60 and job = 'management';
select * from bank_details where age = 60  and loan ='yes';
select * from bank_details where education = 'unknown' or marital = 'single';
#select * from bank_ details where ( education = 'unknown' or marital = 'single') and balance < 500;
...
#select avg( balance) from bank_details where job ='admin';#null
select * from bank_details where age < 45 and job = 'unemployed';
...
create view bank_profile1 as select age , job , balance , education  from bank_details;
select avg(balance) from bank_profile1 where job = 'admin.'
