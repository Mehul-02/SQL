...
create table if not exists bit_course1(
...
select * from bit_course1 where course_lauch_year = 2020;

-- drop table bit_courses1
create table bit_courses11(
course_name varchar(50),
course_id int(10),
course_title varchar(60),
...
insert into bit_courses11 values('machine_learning' , 101 , 'ML', "this is ML course" ,'2019-07-07',3540,'jalpa',2019) ,
...
select * from bit_courses11 where course_launch_year = 2020;

select * from bit_course1 where course_lauch_year = 2020;

select partition_name , table_name , table_rows from information_schema.partitions where table_name = 'bit_courses11';
...
select partition_name , table_name , table_rows from information_schema.partitions where table_name = 'bit_courses33';
...
insert into bit_courses6 values('machine_learning' , 101 , 'ML', "this is ML course" ,'2019-07-07',3540,'sudhanshu',2019) ,
...
insert ignore into bit_courses9 values('machine_learning' , 101 , 'ML', "this is ML course" ,'2019-07-07',3540,'jalpa',2019) ,
...
insert ignore into bit_courses10 values('machine_learning' , 101 , 'ML', "this is ML course" ,'2019-07-07',3540,'jalpa',2019) ,
